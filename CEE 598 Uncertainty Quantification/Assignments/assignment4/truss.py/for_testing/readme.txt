...
2. Installing the py Package

A. Change to the directory that contains the file setup.py and the subdirectory py. If 
...
3. Using the py Package

The py package is on your Python path. To import it into a Python script or session, 
execute:
